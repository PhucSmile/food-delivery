                    ...
                    <Row>
                        <Col lg={6} md={6}>
                            <div className="hero__content">
                                ...
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui magni delectus tenetur
                            ...
                            <div className="food__category d-flex align-items-center justify-content-center gap-4 mb-5">
                                ...
                                <button
                                    className={`d-flex align-items-center gap-2 ${
                                        category === 'BURGER' ? 'foodBtn__Active' : ' '
                                    }`}
                                ...
                                <button
                                    className={`d-flex align-items-center gap-2 ${
                                        category === 'PIZZA' ? 'foodBtn__Active' : ' '
                                    }`}
                                ...
                                <button
                                    className={`d-flex align-items-center gap-2 ${
                                        category === 'BREAD' ? 'foodBtn__Active' : ' '
                                    }`}
                        ...
                        <Col lg={6} md={6}>
                            <div className="testimonial ">
                                ...
                                <p className="testimonial-desc">
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Distinctio quasi qui minus
                                    quos sit perspiciatis inventore quis provident placeat fugiat!
                                </p>
                                <TestimoniaSlider />
                            </div>
                        </Col>
